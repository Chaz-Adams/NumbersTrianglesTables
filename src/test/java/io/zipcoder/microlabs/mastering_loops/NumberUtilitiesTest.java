...
public class NumberUtilitiesTest {
    ...
    public void testGetRange1A() {
        ...
        int stop = 10; //Chaz changed this from 11 it was wrong
    ...
    public void testGetRange3B() {
        // : Given
        String expected = "100101102103104105106107108109";//Leon forgot to add 102
        int start = 100;
        int stop = 110;
    ...
    public void testGetEvenNumbers() {
        // : Given
        String expected = "681012141618"; // changed even and odd expected
        int start = 5;
        int stop = 20;
